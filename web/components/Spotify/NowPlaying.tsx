...
export default function NowPlaying() {
  ...
  return (
    <div className="mb-10">
      <h2 className="text-3xl"><span className={`${(data?.isPlaying ? 'text-terminal-green' : 'text-red')}`}>~/spotify</span> <span className='text-white'>$ cat my_current.jam<BlinkingCursor cursor={'_'}/></span></h2>

      {(data?.isPlaying && (
        <div className="flex flex-row-reverse items-center sm:flex-row mb-8 space-x-0 sm:space-x-2 w-full my-6">
        ...
        <p className="text-gray-500 dark:text-gray-300 my-6">
          Not Playing
        </p>
      )}
    </div>
