...
const LastPageViewed = () => {
  ...
  const [chart] = useState(sdk.createChart({chartId: 'aa3fab73-29e7-4b0f-a7c2-0323f5df2da9',height: '200px', background: "transparent", theme: "dark"}));
